...
angular.module('HotelReview')
    .controller('DetailController', ['APP_CONFIG', 'GPlace', '$localStorage', '$ionicPopup', '$cordovaSocialSharing', '$state', '$log', function(APP_CONFIG, GPlace, $localStorage, $ionicPopup, $cordovaSocialSharing, $state, $log) {
        var ctrl = this;
        GPlace
